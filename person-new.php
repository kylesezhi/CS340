...
<div id="menu">
    ...
    <div class="content">
        <h2 class="content-subhead">Create a New Person</h2>
        <p>
        ...
        <form class="pure-form pure-form-stacked" method="post" action="person-new-do.php">
            <fieldset>
                ...
                <div class="pure-g">
                    <div class="pure-u-1-3">
                        ...
                        <input name="person-first-name" type="text" placeholder="" required>
                    </div>

                    <div class="pure-u-1-3">
                        <label for="last-name">Last Name</label>
                        <input name="person-last-name" type="text" placeholder="" required>
                    </div>

                    <div class="pure-u-1-3">
                        <label for="email">E-mail</label>
                        <input name="person-email" type="email" placeholder="">
                    </div>

                    <div class="pure-u-1-3">
                        <label for="delivery-pref">Delivery Preference</label>
                        <input name="person-delivery-pref" type="text" placeholder="">
                    </div>
                </div>
                <p>
